...
const Home = () => {
  const data = [
    ...
    {
      id: 3,
      head: "FB Dropship Store Management ",
      aos: 'fade-left',
  ...
  return (
    <div className="home">
      <Landing
        ...
        description={"Your E-Commerce business can be created, modified, and scaled fully through our Management Service."}
      />
          ...
          <Row>
            {data.map((service) => (
              <Col lg={4} key={service.id}>
                <Card className="home__card__body" data-aos={service.aos}>
